        ...
        <div className="flex min-h-screen bg-[#2F2A24] text-[#F7F1E3] font-body">
          <main className="pt-28 px-12 pb-20 w-full mx-auto">
            ...
            <div className="grid grid-cols-12 gap-5 mb-16">
              ...
              <div className="col-span-12 lg:col-span-4 grid grid-cols-2 gap-5 order-2">
              ...
              {latestEvent ? (
                <div className="col-span-12 lg:col-span-8 relative overflow-hidden h-90 border border-[#ffffff]/5 order-1">
                  <Image
                    ...
                    <div className="max-w-md">
                      ...
                      <div className="flex flex-col gap-3 text-[#b4a692] font-label text-xs uppercase tracking-widest">
                        <span className="flex items-center gap-2">
                          ...
                          />
                          {latestEvent.date
                            ? format(new Date(latestEvent.date), "MMM dd, yyyy")
                            : "Loading..."}
                        </span>
                        <span className="flex items-center gap-2">
                ...
                <div className="col-span-12 lg:col-span-8 relative h-90 overflow-hidden rounded-lg border border-[#ffffff]/5">
                  {/* Background Image */}
                  <Image
                    src="https://img.freepik.com/premium-vector/minimalist-landscape-abstract-background-wallpaper-creative-modern-paint-aesthetic-nature-art-rive_858664-14618.jpg?w=1480"
                    alt="No Event"
                    width={100}
                    height={100}
                    unoptimized
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {profile?.reviews?.slice(0, 2)?.length ? (
                  // Map over actual reviews
                  ...
                  <div className="col-span-1 md:col-span-2 relative h-80 rounded-lg overflow-hidden border border-[#ffffff]/10 shadow-lg">
                    {/* Background Image */}
                    <Image
                      src="https://wallpapers.com/images/high/meaningful-pictures-1200-x-800-nxxuc784396i2f0d.webp"
                      alt="No Appraisals"
                      width={100}
                      height={100}
                      unoptimized
                    ...
                    {/* Overlay */}
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                      <p className="text-[#C8B273] text-lg md:text-xl font-headline font-bold uppercase tracking-widest">
                        No appraisals yet
                      </p>
                    </div>
                  </div>
                ...
                {topEvents && topEvents.length > 0 ? (
                  topEvents.map((event) => (
                    <div key={event?.id} className="space-y-4 group">
                      <div className="aspect-4/5 bg-[#f6ece3] overflow-hidden border border-[#ffffff]/5 grayscale hover:grayscale-0 transition-all duration-700 rounded-lg">
                        <Link href={`/events/event-details/${event?.id}`}>
                          <Image
                            className="w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-700 cursor-pointer"
                            src={event?.image}
                            unoptimized
                            width={100}
                            height={100}
                  ...
                  // Empty Placeholder
                  <div className="col-span-3 w-full md:col-span-3 aspect-5/5 h-80 relative rounded-lg overflow-hidden border border-[#ffffff]/10 shadow-lg">
                    <Image
                      src="https://img.freepik.com/premium-photo/minimalist-aesthetic-design-dark-nature-wallpaper-generative-ai_556176-1184.jpg"
                      alt="No Events"
                      width={100}
                      height={100}
                      unoptimized
                    ...
                    <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                      <p className="text-[#C8B273] text-lg md:text-xl font-headline font-bold uppercase tracking-widest text-center px-4">
                        No Top Events Available At This Moment
                      </p>
                    </div>
                  </div>
                )}
